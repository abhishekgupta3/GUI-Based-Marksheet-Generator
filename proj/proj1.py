...
def create_excel(row, postive_marks, negative_marks):
    ...
    img = openpyxl.drawing.image.Image('proj/iitp_logo.png') # adding image in excel
    img.anchor = 'A1'
    img.height = 81
    img.width = 630
    sheet.add_image(img)
    ...
    sheet['B11'] = postive_marks # user input of postive marks for correct ans
    ...
    sheet['C11'] = negative_marks # user input of negative marks for wrong ans
    ...
    wb.save(f'proj/output/{row[6]}.xlsx')

with open('proj/sample_input/responses.csv') as csvFile:
